...
def homogeneous_coordinates_calc(nonhomogeneous_coordinates):

    homogeneous_coordinates = np.array([
        nonhomogeneous_coordinates[0],
        nonhomogeneous_coordinates[1],
        1
    ])
...
def eight_points_algorithm(sixteen_points):
    ...
    for i in range(0, 8):
        ...
        left_img_point = homogeneous_coordinates_calc(left_img_point)
        right_img_point = homogeneous_coordinates_calc(right_img_point)
